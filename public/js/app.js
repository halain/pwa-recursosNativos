...
//instancia clase de la camara
// const videoNode = document.querySelector('#player');
const videoNode = $('#player');
const camara = new Camara( videoNode[0] );
...
btnLocation.on('click', () => {
    ...
    if (navigator.geolocation) {
        ...
        console.log('Geolocalizacion no soportada para este Browser/OS.');
    }
...
if (navigator.share) {
    ...
    console.log('Share API no soportado por el Browser/OS');
}
